...
:feature creature: n. [poss. fr. slang `creature feature' for a horror movie]
1. One who loves to add features to designs or programs, perhaps at the
expense of coherence, concision, or {taste}. 2. Alternately, a mythical being
that induces otherwise rational programmers to perpetrate such crocks. see
also {feeping creaturism}, {creeping featurism}. :feature creep: n. [common]
The result of {creeping featurism}, as in "Emacs has a bad case of feature
...
of a propeller beanie), {splat}, `open-apple' or (officially, in Mac
documentation) the `command key'. In French, the term `papillon' (butterfly)
has been reported. The proliferation of terms for this creature may
