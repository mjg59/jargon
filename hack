...
hack. For example, MacLISP has features for reading and printing roman
numerals, which was installed purely for hack value. 12. [UNIX] A dungeon
game similar to ROGUE (q.v.) but more elaborate, distributed in C source over
USENET and very popular at UNIX sites and on PC-class machines. Recent
versions are called `nethack'. HAPPY HACKING: A farewell. HOW'S HACKING?: A
friendly greeting among hackers. HACK HACK: A somewhat pointless but friendly
