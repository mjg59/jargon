...
major interest (or project)". "I hack solid-state physics." see {Hacking X
for Y}. 5. vt. To pull a prank on. see sense 2 and {hacker} (sense 5). 6. vi.
...
ledges, and steam tunnels of a large, institutional building, to the dismay
of Physical Plant workers and (since this is usually performed at educational
...
see also {vadding}. Constructions on this term abound. They include `happy
hacking' (a farewell), `how's hacking?' (a friendly greeting among hackers)
and `hack, hack' (a fairly content-free but friendly comment, often used as a
