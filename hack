...
brilliant prac- tical joke, where neatness is correlated with clever- ness,
...
time (as opposed to TOOL). "Whatcha up to?" "Oh, just hacking." 10. HACK UP
...
HACKING?: A friendly greeting among hackers. HACK HACK: A some- what
pointless but friendly comment, often used as a temporary farewell. [The word
HACK doesn't really have 69 different meanings. In fact, HACK has only one
mean- ing, an extremely subtle and profound one which defies articulation.
