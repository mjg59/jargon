 PM: /pee em/ 1. [from `preventive maintenance'] v. To bring down a machine
for inspection or test purposes; see {scratch monkey}. 2. n. Abbrev. for
`Presentation Manager', an {elephantine} OS/2 graphical user interface. pod:
[allegedly from acronym POD for `Prince Of Darkness'] n. A Diablo 630 (or,
latterly, any impact letter-quality printer). From the DEC-10 PODTYPE program
used to feed formatted text to same. poke: n.,vt. see {peek}. poll: v.,n. 1.
