 MUD: [acronym, Multi User Dungeon; alt. Multi-User Dimension] 1. n. A class
...
early 1980s, and descendants of that game still exist today (see
{BartleMUD}). The title `MUD' is still copyright to the commercial MUD run by
Bartle on British Telecom (their motto: "You haven't *lived* 'til you've
*died* on MUD!"); however, this did not stop students on the European
academic networks from copying/improving on the MUD concept, from which
sprung several new MUDs (VAXMUD, AberMUD, LPMUD). Many of these had
associated bulletin-board systems for social interaction. Because USENET
feeds have been spotty and difficult to get in Great Britain and the British
JANET network doesn't support {FTP} or remote login via telnet, the MUDs
became major foci of hackish social interaction there. AberMUD and other
variants crossed the Atlantic around 1988 and quickly gained popularity in
the US; they became nuclei for large hacker communities with only loose ties
to traditional hackerdom (some observers see parallels with the growth of
USENET in the early 1980s). The second wave of MUDs (TinyMUD and variants)
...
TinyMud. The trend towards greater programmability and flexibility will
doubtless continue. The state of the art in MUD design is still moving very
rapidly, with new simulation designs appearing (seemingly) every month. There
is now (early 1991) a move afoot to deprecate the term {MUD} itself, as newer
designs exhibit an exploding variety of names corresponding to the different
simulation styles being explored. see also {BartleMUD}, {berserking},
{bonk/oif}, {brand brand brand}, {FOD}, {hack-and-slay}, {link-dead},
{mudhead}, {posing}, {talk mode}, {tinycrud}. mudhead: n. Commonly used to
refer to a {MUD} player who sleeps, breathes, and eats MUD. Mudheads have
frequently been known to fail their degrees, drop out, etc., with the
consolation, however, that they made wizard level. When encountered in
person, all a mudhead will talk about is two topics: the tactic, character,
or wizard that in his/her view is always unfairly stopping him/her from
becoming a wizard or beating a favorite MUD, and the MUD he/she is
writing/going to write because all existing MUDs are so dreadful! see also
{wannabee}. multician: /muhl-ti'shn/ [coined at Honeywell, ca.1970] n.
Competent user of {Multics}. Perhaps oddly, no one has ever promoted the
analogous `Unician'. Multics: /muhl'tiks/ n. [from "MULTiplexed Information
and Computing Service"] An early (late 1960s) timesharing operating system
...
metasyntactic variable, like {foo}. 4. When used as a question ("Mumble?")
means "I didn't understand you." 5. Sometimes used in `public' contexts
on-line as a placefiller for things one is barred from giving details about.
For example, a poster with pre-released hardware in his machine might say
"Yup, my machine now has an extra 16M of mem, thanks to the card I'm testing
for Mumbleco." munch: [often confused with `mung', q.v.] vt. To transform
information in a serial fashion, often requiring large amounts of
computation. To trace down a data structure. Related to {crunch} and nearly
synonymous with {grovel}, but connotes less pain. munching: n. Exploration of
security holes of someone else's computer for thrills, notoriety, or to annoy
the system manager. Compare {cracker}. see also {hacked off}. munching
squares: n. A {display hack} dating back to the PDP-1 (c.1962, reportedly
...
mundane life...." mung: /muhng/ alt. `munge' /muhnj/ [in 1960 at MIT, `Mash
Until No Good"; sometime after that the derivation from the {{recursive
acronyms}} `Mung Until No Good' became standard] vt. 1. To make changes to a
file, often large-scale, usually irrevocable. Occasionally accidental. see
{BLT}. 2. To destroy, usually accidentally, occasionally maliciously. The
system only mungs things maliciously; this is a consequence of {Murphy's
Law}. see {scribble}, {mangle}, {trash}, {nuke}. Reports from {USENET}
...
confusion over the proper spelling of {kluge}). 3. The kind of beans of which
the sprouts are used in Chinese food. (That's their real name! Mung beans!
Really!) Murphy's Law: prov. The correct, *original* Murphy's Law reads: "If
there are two or more ways to do something, and one of those ways can result
in a catastrophe, then someone will do it." This is a principle of defensive
design, cited here because it's usually given in mutant forms which are less
descriptive of the challenges of design for lusers. For example, you don't
make a two-pin plug symmetrical and then label it `THIS WAY UP'; if it
matters which way it's plugged in, then you make the design asymmetrical.
...
tolerances. One experiment involved a set of 16 accelerometers mounted to
different parts of the subject's body. There were two ways each sensor could
be glued to its mount, and somebody methodically installed all 16 the wrong
way around. Murphy then made the original form of his pronouncement, which
the test subject (Major John Paul Stapp) quoted at a news conference a few
days later. Within months `Murphy's Law' had spread to various technical
cultures connected to aerospace engineering. Before too many years had gone
by variants had passed into the popular imagination, mutating as they went.
Obviously, pop-culture versions in the vein of "Anything that can go wrong,
will." demonstrate Murphy's Law acting on itself! Music:: n. A common
extracurricular interest of hackers (compare {{Science-Fiction Fandom}},
{{Oriental Food}}; see also {filk}). It is widely believed among hackers that
there is a substantial correlation between whatever mysterious traits
underlie hacking ability (on the one hand) and musical talent and sensitivity
(on the other). It is certainly the case that hackers, as a rule, like music
and often develop musical appreciation in unusual and interesting directions.
Folk music is very big in hacker circles; so is electronic music, and the
sort of elaborate instrumental jazz/rock that used to be called `progressive'
and isn't recorded much any more. The hacker's musical range tends to be
wide; many can listen with equal appreciation to (say) Talking Heads, Yes,
Gentle Giant, Spirogyra, Scott Joplin, Tangerine Dream, King Sunny Ade, The
Pretenders, or Bach's Brandenburg Concerti. It is also apparently true that
...
fingers of ordinary mortals. Frequently in `mutter an {incantation}'. see
also {wizard}. = N = ===== N: /en/ quant. 1. A large and indeterminate number
of objects; "There were N bugs in that crock!"; also used in its original
