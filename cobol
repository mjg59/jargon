...
{evil}.) A weak, verbose, and flabby language used by {card walloper}s to do
...
one is Edsger W. Dijkstra's famous observation that "The use of COBOL
cripples the mind; its teaching should, therefore, be regarded as a criminal
offense." (from "Selected Writings on Computing: A Personal Perspective") see
also {fear and loathing}, {software rot}.