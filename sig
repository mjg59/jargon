 SIG (sig) or SIG BLOCK (sig blahk) [UNIX; often written ".sig" there] n.
...
sayings; but many consider large sigs a waste of bandwidth, and it has been
observed that the size of one's sig block is usually inversely proportional
