...
early 1980s, LISP now shares the throne with {C}. Its partisans claim it is
the only language that is truly beautiful. see {languages of choice}. All
LISP functions and programs are expressions that return values; this,
...
programmers know the value of everything and the cost of nothing". One
significant application for LISP has been as a proof by example that most
