...
hands-down favorite of a plurality of hackers until the early 1980s, LISP now
shares the throne with {C}. see {languages of choice}. All LISP functions and
programs are expressions that return values; this, together with the high
memory utilization of LISPs, gave rise to Alan Perlis's famous quip (itself a
take on an Oscar Wilde quote) that "LISP programmers know the value of
everything and the cost of nothing." literature, the: n. Computer science
journals and other publications vaguely gestured at to answer a question that
the speaker believes is {trivial}. Thus, one might answer an annoying
question "It's in the literature." Oppose {Knuth}, which has no connotation
of triviality. little-endian: adj. Describes a computer architecture in
which, within a given 16- or 32-bit word, bytes at lower addresses have lower
...
anything, but has a virtually infinite amount of work to do and accomplishes
nothing. liveware: n. Synonym for {wetware}. Less common. lobotomy: n. 1.
What a hacker subjected to formal management training is said to have
...
with magazine inserted and prepared for firing] adj. Said of a removable disk
volume properly prepared for use --- that is, locked into the drive and with
the heads loaded. Ironically, because their heads are `loaded' whenever the
power is up, this description is never used of {{Winchester}} drives (which
are named after a rifle). locked up: adj. Syn. for {hung}, {wedged}. logic
bomb: n. Code surreptitiously inserted in an application or OS which causes
it to perform some destructive or security-compromising activity whenever
specified conditions are met. Compare {back door}. logical: [from the
technical term `logical device', wherein a physical device is referred to by
an arbitrary `logical' name] adj. Having the role of. If a person (say, Les
Earnest at SAIL) who has long held a certain post left and was replaced, the
replacement would for a while be known as the `logical' Les Earnest (this
does not imply any judgement on the replacement). Compare {virtual}. At
...
onto {El Camino Bignum} going logical north." Using the word `logical' helps
to prevent the recipient from worrying about that the fact that the sun is
...
Route 128 (famous for the electronics industry that has grown up along it) is
a three-quarters circle surrounding Boston at a radius of ten miles,
...
Refers to something which is {losing}, especially in the phrases "That's a
lose!" or "What a lose!". lose lose: interj. A reply to or comment on an
...
just outshore of a beach and can be dangerous to swimmers). "Well, sure,
photon pressure from the stadium lights alters the path of a thrown baseball,
but that effect gets lost in the underflow." see also {overflow bit}. lots of
