...
Larry Wall, author of patch(1) and rn(1)). Superficially resembles {awk}, but
is much hairier, including many facilities reminiscent of sed(1) and shells
...
remark about lex(1), as the {Swiss-Army chainsaw} of Unix programming. Though
Perl is very useful, it would be a stretch to describe it as pretty or
